...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 11 22:04:14 2019
...
image_train['Output'] = np.where((image_train['index']== 'BRICKFACE'), 1,0)
...
img_test['Output'] = np.where((img_test['index']== 'BRICKFACE'), 1,0)
...
final['Output'] = np.where((final['index']== 'BRICKFACE'), 1,0)
#%%
